...
<h1 style="text-align:center;">Add New Job</h1><br>
  <div class="container" style="margin-left:30%" >
    <div class="row">
      
      
        <form action="\addNew" class="p-5 bg-white" method="POST">
          ...
          <div class="row form-group mb-5">
            <div class="col-md-12 mb-3 mb-md-0">
              ...
              <input type="text" id="fullname" class="form-control" name="Location" >
            </div>
          </div>
          ...
          <div class="row form-group">
            <div class="col-md-12">
              <input type="submit" value="Add" class="btn btn-primary  py-2 px-5">
            </div>
          </div>
        </form>
</div>
